...
// val prediction stuff
bool PERFECT_VALPRED = false;
bool VAL_PREDICTION = false;
bool SVP_VALPRED = false;
unsigned int VPQ_SIZE = 0;
bool ORACLE_CONF = 0;
unsigned int SVP_INDEX_BITS = 0;
unsigned int SVP_TAG_BITS = 0;
unsigned int CONF_MAX = 0;
unsigned int CONF_INC = 0;
unsigned int CONF_DEC = 0;
unsigned int REPLACE_STRIDE = 0;
unsigned int REPLACE_CONF_THRESHOLD = 0;
bool PRED_INTALU = 0;
bool PRED_FPALU = 0;
bool PRED_LOAD = 0;
...
// uint32_t FU_LANE_MATRIX[(unsigned int)NUMBER_FU_TYPES] = {0x04 /*     BR:
// 0000 0100 */ ,
//                                                           0x03 /*     LS:
//                                                           0000 0011 */ , 0xf8
//                                                           /*  ALU_S: 1111
...
//                                                           MTF: 0000 1000 */
//                                                          };
// uint32_t FU_LANE_MATRIX[(unsigned int)NUMBER_FU_TYPES] = {0xff /*     BR:
// 0000 0100 */ ,
//                                                           0xff /*     LS:
//                                                           0000 0011 */ , 0xff
//                                                           /*  ALU_S: 1111
