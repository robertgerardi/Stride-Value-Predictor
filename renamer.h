...
private:
	...
	uint64_t *AMT;
	 ...
	 // may need size variable
	uint64_t mapTablesSize;
	/////////////////////////////////////////////////////////////////////
	...
	typedef struct activeListEntry{
	...
	typedef struct checkpoints{
		uint64_t * SMT;
		uint64_t FLHead;
		uint64_t FLHeadPhase;
		uint64_t GBM;
	}checkpoints;

	checkpoints *BRCheckpoints;
	/////////////////////////////////////////////////////////////////////
	// Private functions.
